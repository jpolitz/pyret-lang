...
fun make-default-types() block:
  ...
  default-typs.set-now(A.s-global("times").key(), t-number-binop)
  default-typs.set-now(A.s-global("minus").key(), t-number-binop)
  default-typs.set-now(A.s-global("divide").key(), t-number-binop)
  default-typs.set-now(A.s-global("plus").key(), t-number-binop)
  default-typs.set-now(A.s-global("concat").key(), t-number-binop)
  default-typs.set-now(A.s-global("_append").key(), t-number-binop)
